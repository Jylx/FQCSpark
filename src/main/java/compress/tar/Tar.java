...
public class Tar {
    ...
    public void FSfetch(String inputfile, String outfile,String finalOut){
        ...
        Path inpath = new Path(outfile);//spark并行压缩结果文件夹
    ...
    public static void archive(File srcFile, File destFile) throws IOException {
        System.out.println("归档文件 开始：" + srcFile + " => " + destFile);
        ...
        System.out.println("归档文件 结束：耗时：" + (System.currentTimeMillis() - start)/1000 + "s");
    }
    ...
    public static void bscCompress(String srcFileName, String bscFileName) {
        System.out.println("bsc压缩 开始：" + srcFileName + " => " + bscFileName);
        long start = System.currentTimeMillis();
